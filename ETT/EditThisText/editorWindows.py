...
class TextEditor(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowIcon(QIcon('icons/NewLook/editor.png')) # Use QIcon instead of QtGui.QIcon
        self.initUI()
    ...
    def initUI(self):
        ...
        newFile = QAction(QIcon(file_selector.select('icons\\NewLook\\new.png')), 'New', self)
    ...
    def aboutWinOpen(self):
        ...
        self.iconLabel.setGeometry(100, 0, 100, 100) # Center that shit, yo
