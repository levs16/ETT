...
class TextEditor(QMainWindow):
    ...
    def initUI(self):
        ...
        saveAsFile = QAction(QIcon('saveas.png'), 'Save As', self)
        ...
        fontChange = QAction(QIcon('font.png'), 'Font', self)
        ...
        self.setWindowTitle('EditThisText v0.4')
        self.show()
